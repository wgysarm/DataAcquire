...
DataAcquireDemo::DataAcquireDemo(QWidget *parent):QWidget(parent),ui(new Ui::DataAcquireDemo)
{
    ui->setupUi(this);
    this->initForm();
    this->initNav();
...
void DataAcquireDemo::initForm()
{
    ui->labTitle->setText(tr("DataAcquire Platform"));
    ...
    IconTool::Instance()->setIcon(ui->btnReturn, 0xf073, navIcoWidth);
    IconTool::Instance()->setIcon(ui->btnMsg, 0xf27a, navIcoWidth);
    ...
    //主窗体背景
    qss.append(QString("QWidget#widgetMain{border-image:url(%1);}").arg(":/iamge/resource/img/main.jpg"));
...
void DataAcquireDemo::initNav()
{
    ...
    listText << tr("mapsurvey") << tr("devwatch") << tr("recordquery") << tr("mapman") << tr("devman") << tr("syscofig");
    ...
    for (int i = 0; i < btns.count(); i++) {
        ...
        QPixmap pix = IconTool::Instance()->getPixmap(listColorText.at(i), listChar.at(i), iconSize, iconWidth, iconHeight);
...
void DataAcquireDemo::buttonClicked()
{
    QToolButton *btn = (QToolButton *)sender();
    ui->stackedWidget->setCurrentIndex(1);
    ui->labTitle->setText(btn->text());
    IconTool::Instance()->setIcon(ui->btnReturn, 0xf122, navIcoWidth);
}

void DataAcquireDemo::on_btnReturn_pressed()
{
...
void DataAcquireDemo::on_btnMsg_pressed()
{
    exit(0);
}
