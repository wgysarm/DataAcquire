...
IconTool::IconTool(QObject *parent) : QObject(parent)
{
    int fontId = QFontDatabase::addApplicationFont(":/iamge/resource/img/fontawesome-webfont.ttf");
...
IconTool* IconTool::self = 0;
IconTool* IconTool::Instance()
{
    if (!self) {
        QMutex mutex;
...
void IconTool::setIcon(QLabel *lab, QChar c, quint32 size)
{
...
void IconTool::setIcon(QAbstractButton *btn, QChar c, quint32 size)
{
    iconFont.setPointSize(size);
...
QPixmap IconTool::getPixmap(const QString &color, QChar c, quint32 size,
...
QPixmap IconTool::getPixmap(QToolButton *btn, bool normal)
{
    QPixmap pix;
...
void IconTool::setStyle(QWidget *widget, const QString &type, int borderWidth, const QString &borderColor,
...
void IconTool::setStyle(QWidget *widget, QList<QToolButton *> btns, QList<int> pixChar,
...
void IconTool::setStyle(QFrame *frame, QList<QToolButton *> btns, QList<int> pixChar,
                          quint32 iconSize, quint32 iconWidth, quint32 iconHeight,
                          const QString &normalBgColor, const QString &darkBgColor,
                          const QString &normalTextColor, const QString &darkTextColor)
{
...
bool IconTool::eventFilter(QObject *watched, QEvent *event)
{
